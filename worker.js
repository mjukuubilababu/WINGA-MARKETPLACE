  ...
  <div id="app-container" style="display:none;">
    <header id="top-bar" class="panel">
      ...
      <nav id="quick-discovery-rail" aria-label="Quick discovery" data-winga-i18n="shell.quickDiscovery" data-winga-i18n-attr="aria-label" data-winga-i18n-lock>
        ...
        <button type="button" data-discovery-action="offers" hidden aria-hidden="true"><span class="quick-discovery-media"><img src="/icons/navigation/tag.svg" width="28" height="28" alt=""></span><span data-winga-i18n="shell.offers" data-winga-i18n-lock>Offers</span></button>
        <button type="button" data-discovery-action="shops" hidden aria-hidden="true"><span class="quick-discovery-media"><img src="/icons/navigation/store.svg" width="28" height="28" alt=""></span><span data-winga-i18n="shell.shops" data-winga-i18n-lock>Shops</span></button>
      </nav>
    </header>
