...
const MIGRATIONS = Object.freeze([
  ...
  Object.freeze({
    id: "2026083101_video_direct_publish_reconciliation",
    statements: Object.freeze([
      `UPDATE video_upload_intents
       SET moderation_status = CASE WHEN safety_status = 'blocked' THEN 'rejected' ELSE 'approved' END,
         moderated_at = CASE WHEN safety_status = 'blocked' THEN COALESCE(moderated_at, safety_checked_at, NOW()) ELSE moderated_at END,
         moderated_by = CASE WHEN safety_status = 'blocked' AND moderated_by = '' THEN 'video-safety' ELSE moderated_by END,
...
,
  ...
  }), require("./commerce-outcomes"), require("./intelligence-score-durability"), require("./notification-authorization"), require("./social-notification-frequency"), require("./social-analytics"), require("./product-likes"), require("./anonymous-product-views"), require("./commerce-goals"), require("./intelligence-decision-layer"), require("./intelligence-composite-scores"), require("./wip-mind-contracts"), require("./commerce-goal-transitions"), require("./intelligence-decision-outcomes"), require("./ads-v1"), require("./conversation-offers"), require("./conversation-availability")]);
