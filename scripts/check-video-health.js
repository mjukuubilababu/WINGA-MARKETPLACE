...
function normalizeResult(response, body = {}) {
  ...
  return {
    ...
    health: {
      ...
      processingQueueDepth: Number(health.processingQueueDepth || 0),
      ready: Number(health.ready || 0),
      readyWithoutPoster: Number(health.readyWithoutPoster || 0),
      failed: Number(health.failed || 0),
      failedRecent: Number(health.failedRecent || 0),
      cleanupPending: Number(health.cleanupPending || 0),
      cleanupQueueDepth: Number(health.cleanupQueueDepth || 0),
      cleanupDead: Number(health.cleanupDead || 0),
      cleanupStalled: Number(health.cleanupStalled || 0),
      ...
      transcodeFailureRate: Number(health.transcodeFailureRate || 0),
      posterFailureRate: Number(health.posterFailureRate || 0),
      ...
      safetyQueueDepth: Number(health.safetyQueueDepth || 0),
      ...
      playbackPauses: Number(health.playbackPauses || 0),
      playbackResumes: Number(health.playbackResumes || 0),
      playbackReplays: Number(health.playbackReplays || 0),
      playbackMutes: Number(health.playbackMutes || 0),
      playbackUnmutes: Number(health.playbackUnmutes || 0),
      ...
      averagePlaybackStartLatencyMs: Number(health.averagePlaybackStartLatencyMs || 0),
      p95PlaybackStartLatencyMs: Number(health.p95PlaybackStartLatencyMs || 0),
      playbackTokenCacheHitRate: Number(health.playbackTokenCacheHitRate || 0),
      playbackPrewarmHitRate: Number(health.playbackPrewarmHitRate || 0),
      playbackBigPipePrefetchHitRate: Number(health.playbackBigPipePrefetchHitRate || 0),
